...
через OVMF). **Wi-Fi у віртуалці без адаптера:** у гості
`modprobe mac80211_hwsim` створює віртуальні Wi-Fi-радіо; піднявши на одному
hostapd, другим можна пройти весь Wi-Fi-екран по-справжньому. Або просто
завантаж ISO з флешки на ноутбуці — до екрана Wi-Fi йти ~20 секунд,
